...
namespace ProyectoDB.DataSet.FacturasDataSetTableAdapters {
    ...
    public partial class DetalleFacturaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "DELETE FROM DetalleFactura\r\nWHERE        (NoFactura = @NoFactura)";
            ...
            this._commandCollection[2].CommandText = "SELECT        isv, Total, cantidadProducto, NoFactura, idProducto\r\nFROM          " +
                "  DetalleFactura\r\nWHERE        (NoFactura = @NoFactura)";
        ...
        public virtual int FillByDeleteFactura(FacturasDataSet.DetalleFacturaDataTable dataTable, int NoFactura) {
        ...
        public virtual FacturasDataSet.DetalleFacturaDataTable GetDataByDeleteFactura(int NoFactura) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(NoFactura));
            FacturasDataSet.DetalleFacturaDataTable dataTable = new FacturasDataSet.DetalleFacturaDataTable();
            this.Adapter.Fill(dataTable);
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByFactura(FacturasDataSet.DetalleFacturaDataTable dataTable, int NoFactura) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual FacturasDataSet.DetalleFacturaDataTable GetDataByFactura(int NoFactura) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(NoFactura));
            FacturasDataSet.DetalleFacturaDataTable dataTable = new FacturasDataSet.DetalleFacturaDataTable();
            this.Adapter.Fill(dataTable);
    ...
    public partial class FacturaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::MySql.Data.MySqlClient.MySqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "DELETE FROM Factura\r\nWHERE        (noFactura = @noFactura)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            global::MySql.Data.MySqlClient.MySqlParameter param = new global::MySql.Data.MySqlClient.MySqlParameter();
            param.ParameterName = "@noFactura";
            param.DbType = global::System.Data.DbType.Int32;
            ...
            this._commandCollection[2] = new global::MySql.Data.MySqlClient.MySqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT Direccion, FechaEmision, RTN, codigoTienda, idCliente, noFactura FROM Fact" +
            ...
            this._commandCollection[3].CommandText = "SELECT        noFactura, Direccion, RTN, FechaEmision, idCliente, codigoTienda\r\nF" +
                "ROM            Factura\r\nWHERE        (noFactura = @noFactura)\r\nORDER BY noFactur" +
                "a DESC";
        ...
        public virtual int DeleteQuery(int noFactura) {
    ...
    public partial class ClienteTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::MySql.Data.MySqlClient.MySqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT        idCliente, nombreCliente\r\nFROM            Cliente\r\nWHERE        (id" +
                "Cliente = @idCliente)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            global::MySql.Data.MySqlClient.MySqlParameter param = new global::MySql.Data.MySqlClient.MySqlParameter();
            param.ParameterName = "@idCliente";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByCliente(FacturasDataSet.ClienteDataTable dataTable, int idCliente) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(idCliente));
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual FacturasDataSet.ClienteDataTable GetDataByCliente(int idCliente) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(idCliente));
            FacturasDataSet.ClienteDataTable dataTable = new FacturasDataSet.ClienteDataTable();
            this.Adapter.Fill(dataTable);
